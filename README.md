...
- Mode invité : toute l'app est accessible sans compte (aucune connexion obligatoire)
- Authentification Supabase complète et réelle (connexion, inscription, mot de passe oublié) avec messages d'erreur en français, proposée au moment de sauvegarder (écran Profil), pas imposée à l'entrée
- Écran Profil adaptatif : invitation à créer un compte pour les invités, informations de compte + déconnexion pour les utilisateurs connectés
