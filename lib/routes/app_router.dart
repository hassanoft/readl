...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // READL est utilisable sans compte (mode invité) : aucune page
      // n'est bloquée. Seul un utilisateur déjà connecté qui atterrit
      // sur une page de connexion/inscription est renvoyé à l'accueil.
