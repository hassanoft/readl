...
/// l'état d'authentification Supabase change (connexion, déconnexion,
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      // Laisse le splash décider lui-même de sa première redirection
      // (onboarding vs connexion vs accueil).
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          if (document is! ReadlDocument) return const _NotFoundScreen();
          return ReaderScreen(document: document);
        },
      ),
      GoRoute(
